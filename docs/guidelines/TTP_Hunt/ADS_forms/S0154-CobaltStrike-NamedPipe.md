...
2. Inspect named pipe pattern if matching "MSSE-x-server"
3. Examine the InitiatingProcessFolderPath folder location, and check for any mistype on service name  
