...
The WASOC has been made aware of a vulnerability affecting Node.js hostname handling.

The vulnerability allows an attacker to exploit Embedded-nul hostnames can lead to silent authority rebinding due to c-string truncation in resolver bindings.
