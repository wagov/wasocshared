# Google Chrome Vulnerabilities - 20261603001

## Overview

Google Chrome has released a high security advisory addressing vulnerabilities that could allow remote code execution by an attacker affecting Google Chrome products.
...
- VENDOR: <https://chromereleases.googleblog.com/2026/03/stable-channel-update-for-desktop_12.html>

## Additional References

- PUBLICATION NAME: <https://www.cisa.gov/known-exploited-vulnerabilities-catalog>
