# Citrix Bleed ACT NOW - Ensure Citrix ADC & Netscaler are not internet accessible - 20231115001
...
The WA SOC recommends all impacted devices are taken offline or configured to ensure they cannot be reached from the internet. Further advice will be provided if an alternate remediation is deemed suitable.
